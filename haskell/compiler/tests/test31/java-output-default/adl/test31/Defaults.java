  ...
  public static JsonBinding<Defaults> jsonBinding() {
    ...
    return new JsonBinding<Defaults>() {
      ...
      public Defaults fromJson(JsonElement _json) {
        ...
        return new Defaults(
          _obj.has("withDefault") ? JsonBindings.fieldFromJson(_obj, "withDefault", withDefault.get()) : "abc",
          _obj.has("structWithDefault") ? JsonBindings.fieldFromJson(_obj, "structWithDefault", structWithDefault.get()) : new Leaf("xyz"),
